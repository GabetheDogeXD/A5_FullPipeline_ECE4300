...
instrMem.v - stores the "instructions", initializes an array of 2^10 32-bit registers, populates the first 10 entries with dummy instructions, then outputs the data from an input address from pc.v on every clock cycle.  <br />
...
top.v - top module, wires everything together. <br />
